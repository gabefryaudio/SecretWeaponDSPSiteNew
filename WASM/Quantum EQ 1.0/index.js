...
import * as patch from "./cmaj_Quantum_EQ.js";
...
class CmajNode extends CompositeAudioNode
{
  ...
  setup (patchConnection, paramManagerNode)
  {
    ...
    // MIDI input removed - not needed for EQ plugin
  }
...
export default class CmajModule extends WebAudioModule
{
  async createAudioNode (options)
  {
    ...
    this.patchConnection = await patch.createAudioWorkletNodePatchConnection (this.audioContext, "Quantum_EQ");
