...
import * as patch from "./cmaj_Canvas_Compressor.js";
...
export default class CmajModule extends WebAudioModule
{
  async createAudioNode (options)
  {
    ...
    this.patchConnection = await patch.createAudioWorkletNodePatchConnection (this.audioContext, "Canvas_Compressor");
